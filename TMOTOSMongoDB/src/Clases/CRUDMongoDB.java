...
public class CRUDMongoDB extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        rSPanelGradiente1.setColorPrimario(new java.awt.Color(51, 153, 0));
        rSPanelGradiente1.setColorSecundario(new java.awt.Color(51, 51, 0));
    ...
    public void mostrar() {
        String[] titulos = {"ID", "Modelo", "Precio", "Proveedor"};
        ...
        while (cursor.hasNext()) {
            ...
            registros[1] = "" + cursor.curr().get("Modelo") + "";
            registros[2] = "" + cursor.curr().get("Precio") + "";
            registros[3] = "" + cursor.curr().get("Proveedor") + "";
    ...
    public void actualizar() {
        ...
        actualizarAlumno.put("Modelo", txtnombre.getText());
        actualizarAlumno.put("Precio", Integer.parseInt(txtedad.getText()));
        actualizarAlumno.put("Proveedor", txtcarrera.getText());
    ...
    public void docbackup() {
        ...
        backup.put("Modelo", txtnombre.getText());
        backup.put("Precio", Integer.parseInt(txtedad.getText()));
        backup.put("Proveedor", txtcarrera.getText());
    }
    ...
    public void save() {
        ...
        documento.put("Modelo", txtnombre.getText());
        documento.put("Precio", Integer.parseInt(txtedad.getText()));
        documento.put("Proveedor", txtcarrera.getText());
